...
namespace BlisterPillInspection.ViewModels.Pages;
...
public sealed partial class BlisterCheckPageViewModel : PageViewModelBase
{
    ...
    public string MotionCardStatusText
    {
        get
        {
            ...
            bool isVirtual = _motionCardService is BlisterPillInspection.Services.MotionCard.FallbackMotionCardService fallback && fallback.IsVirtual;
